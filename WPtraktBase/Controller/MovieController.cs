...
namespace WPtraktBase.Controller
{
    public class MovieController
    {
        ...
        public TraktMovie[] getRecentMovies()
        {
            return this.movieDao.getRecentMovies();
        }
        ...
        public async Task<TraktMovie[]> getUserSuggestions()
        {
            List<TraktMovie> filteredMovies = new List<TraktMovie>();
            TraktMovie[] movies = await movieDao.getUserSuggestions();
        ...
        public async Task<TraktMovie[]> getUserMovies()
        {
            return await movieDao.getUserMovies();
        }

        public async Task<TraktMovie[]> getUserWatchlist()
        {
            return await movieDao.getUserWatchlist();
        }
        ...
        public TraktMovie getRandomMovie()
        {
            Random random = new Random();
            TraktMovie[] allMovies = movieDao.getAllMovies();

            if (allMovies == null || allMovies.Length == 0)
                return null;

            return allMovies[random.Next(0, allMovies.Length - 1)];
        }
    }
}
