...
namespace WPtrakt
{
    public partial class ViewTrending : PhoneApplicationPage
    {
        ...
        private void TrendingList_ItemRealized(object sender, ItemRealizationEventArgs e)
        {
            TrendingListItemViewModel model = (TrendingListItemViewModel)e.Container.DataContext;
            model.LoadScreenImage();
        }

        private void TrendingList_ItemUnrealized(object sender, ItemRealizationEventArgs e)
        {
            TrendingListItemViewModel model = (TrendingListItemViewModel)e.Container.DataContext;
