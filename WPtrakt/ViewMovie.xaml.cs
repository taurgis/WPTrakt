...
namespace WPtrakt
{
    public partial class ViewMovie : PhoneApplicationPage
    {
        ...
        {
            App.TrackEvent("ViewMovie", "Switched panorama to " + this.MoviePanorama.SelectedIndex);
            ReloadAppBar();
        }

        private void ReloadAppBar()
        {
            lastIndex = MoviePanorama.SelectedIndex;
        ...
        private async void LoadBackgroundImage()
        {
            if ((AppUser.Instance.BackgroundWallpapersEnabled || (AppUser.Instance.ImagesWithWIFI && StorageController.IsConnectedToWifi())))
            {
                ...
                {
                    ImageSource = await movieController.getFanartImage(this.Movie.imdb_id, this.Movie.Images.Fanart),
                    Opacity = 0.0,
        ...
        {
            progressBarLoading.Visibility = System.Windows.Visibility.Visible;
            App.TrackEvent("ViewMovie", "Watchlist");
        ...
        {
            progressBarLoading.Visibility = System.Windows.Visibility.Visible;
            App.TrackEvent("ViewMovie", "Unseen");
        ...
        private async void sendButton_Click(object sender, EventArgs e)
        {
            ...
            {
                App.TrackEvent("ViewMovie", "Add shout");
