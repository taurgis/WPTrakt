        ...
        private void Shout(TraktActivity activity)
        {
            switch (activity.Type)
            {
                ...
                case "show":
                    ...
                    break;
                case "episode":
                    this.HistoryItems.Add(new ActivityListItemViewModel() { Activity = "added shout to episode " + activity.Episode.Title + ".", Name = activity.User.Username, Time = activity.When.Day + " - " + activity.When.Time, Tvdb = activity.Show.tvdb_id, Screen = activity.Episode.Images.Screen, Type = "episode", Season = Int16.Parse(activity.Episode.Season), Episode = Int16.Parse(activity.Episode.Number) });
                    break;
            }
        }
        ...
        private void Collection(TraktActivity activity)
        {
            switch (activity.Type)
            {
                ...
                case "show":
                    ...
                    break;
                case "episode":
                    this.HistoryItems.Add(new ActivityListItemViewModel() { Activity = "added " + activity.Episode.Title + "to the collection", Name = activity.User.Username, Time = activity.When.Day + " - " + activity.When.Time, Tvdb = activity.Show.tvdb_id, Screen = activity.Episode.Images.Screen, Type = "episode", Season = Int16.Parse(activity.Episode.Season), Episode = Int16.Parse(activity.Episode.Number) });
                    break;
            }
        }
        ...
        private void Scrobble(TraktActivity activity)
        {
            switch (activity.Type)
            {
                ...
                case "show":
                    ...
                    break;
                case "episode":
                    this.HistoryItems.Add(new ActivityListItemViewModel() { Activity = "scrobbled " + activity.Episode.Title + ".", Name = activity.User.Username, Time = activity.When.Day + " - " + activity.When.Time, Tvdb = activity.Show.tvdb_id, Screen = activity.Episode.Images.Screen, Type = "episode", Season = Int16.Parse(activity.Episode.Season), Episode = Int16.Parse(activity.Episode.Number) });
                    break;
            }
        }
        ...
        private void Checkin(TraktActivity activity)
        {
            switch (activity.Type)
            {
                ...
                case "show":
                    ...
                    break;
                case "episode":
                    this.HistoryItems.Add(new ActivityListItemViewModel() { Activity = "checked in " + activity.Episode.Title + ".", Name = activity.User.Username, Time = activity.When.Day + " - " + activity.When.Time, Tvdb = activity.Show.tvdb_id, Screen = activity.Episode.Images.Screen, Type = "episode", Season = Int16.Parse(activity.Episode.Season), Episode = Int16.Parse(activity.Episode.Number) });
                    break;
            }
        }
        ...
        private void AddToWatchList(TraktActivity activity)
        {
            switch (activity.Type)
            {
                ...
                case "show":
                    ...
                    break;
                case "episode":
                    this.HistoryItems.Add(new ActivityListItemViewModel() { Activity = "added " + activity.Episode.Title + "to the watchlist", Name = activity.User.Username, Time = activity.When.Day + " - " + activity.When.Time, Tvdb = activity.Show.tvdb_id, Screen = activity.Episode.Images.Screen, Type = "episode", Season = Int16.Parse(activity.Episode.Season), Episode = Int16.Parse(activity.Episode.Number) });
                    break;
            }
        }
